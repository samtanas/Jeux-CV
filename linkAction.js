...
var linkAction = {
  spriteLink : [[  // indice 0 sort du lit
      ...
      new ConstructOfPosition(-314, -127, 16, 16, {indice : 7}),//indice 0 buisson
      new ConstructOfPosition(-335, -128, 16, 15, {indice : 8}),//indice 1 pierre claire
      new ConstructOfPosition(-358, -129, 16, 15, {indice : 8}),//indice 2 pierre foncé
      new ConstructOfPosition(-379, -128, 12, 13, {indice : 8}),//indice 3 jar
      ...
      new ConstructOfPosition(-66, -398, 7, 7),//indice 0
      new ConstructOfPosition(-82, -398, 7, 7),//indice 1
      new ConstructOfPosition(-98, -398, 8, 7),//indice 2
      new ConstructOfPosition(-111, -398, 7, 7),//indice 3
      new ConstructOfPosition(-124, -398, 7, 7),//indice 4
      new ConstructOfPosition(-139, -398, 7, 7),//indice 5
      new ConstructOfPosition(-155, -398, 7, 7),//indice 6
      new ConstructOfPosition(-167, -398, 8, 7),//indice 7
      new ConstructOfPosition(-66, -408, 11, 7),//indice 8
      new ConstructOfPosition(-82, -408, 7, 7),//indice 9
      new ConstructOfPosition(-96, -408, 9, 7),//indice 10
      new ConstructOfPosition(-111, -408, 7, 7),//indice 11
      new ConstructOfPosition(-123, -408, 10, 7),//indice 12
      new ConstructOfPosition(-137, -408, 12, 7),//indice 13
      new ConstructOfPosition(-156, -409, 5, 5),//indice 14
      new ConstructOfPosition(-167, -408, 8, 7),//indice 15
      new ConstructOfPosition(-89, -419, 5, 5),//indice 16
      new ConstructOfPosition(-100, -418, 11, 7),//indice 17
      new ConstructOfPosition(-120, -419, 5, 5),//indice 18
      new ConstructOfPosition(-132, -418, 9, 7),//indice 19
      new ConstructOfPosition(-147, -418, 8, 7)//indice 20
    ],[//indice 6 sinthiement aléatoir de l'épée gauche et droite
      new ConstructOfPosition(-767, -418, 7, 7),//indice 0
      new ConstructOfPosition(-783, -419, 7, 7),//indice 1
      new ConstructOfPosition(-798, -718, 8, 7),//indice 2
      new ConstructOfPosition(-811, -418, 7, 7),//indice 3
      new ConstructOfPosition(-825, -418, 7, 7),//indice 4
      new ConstructOfPosition(-840, -419, 7, 7),//indice 5
      new ConstructOfPosition(-856, -418, 7, 7),//indice 6
      new ConstructOfPosition(-869, -417, 7, 8),//indice 7
      new ConstructOfPosition(-769, -428, 7, 11),//indice 8
      new ConstructOfPosition(-784, -428, 7, 7),//indice 9
      new ConstructOfPosition(-798, -428, 7, 9),//indice 10
      new ConstructOfPosition(-812, -429, 7, 7),//indice 11
      new ConstructOfPosition(-825, -428, 7, 10),//indice 12
      new ConstructOfPosition(-840, -428, 7, 12),//indice 13
      new ConstructOfPosition(-857, -431, 5, 5),//indice 14
      new ConstructOfPosition(-869, -428, 7, 8),//indice 15
      new ConstructOfPosition(-792, -444, 5, 5),//indice 16
      new ConstructOfPosition(-805, -441, 7, 11),//indice 17
      new ConstructOfPosition(-823, -444, 5, 5),//indice 18
      new ConstructOfPosition(-836, -442, 7, 9),//indice 19
      new ConstructOfPosition(-851, -442, 7, 8)//indice 20
    ...
    {//test si l'objet et au dessus ou en dessous ou a gauche ou a droite suivant le sens.
      //si tous les test sont vrai à la fin de la boucle retourne true.
        ...
        if (boul){
          ...
          {
            if(link){
              if ( linkEtat.slachSword == 1 || linkEtat.slachSword == 4 ){//renvoie l'objet touché
                linkEtat.touche.keyZPlusObstacle = true;
                linkEtat.collision.position = i;//numéro de l'objet dans le tableau
              } else {
                if ( linkEtat.slachSword == 3 ){//colition avec l'épée chargé
                  linkEtat.slachSword = 0;//annule le coup d'épée
                  background.item['z-index'] = -1;//fait disparaitre le scintillement
                } else {
  ...
  spriteSelection : function ( temps, spriteAction, defautSprite, direction ){
    if ( linkEtat.slachSword != 3 ){//la position est bloqué si l'épée est chargé
  ...
  testDirection : function(){
    if ( !linkEtat.timeObstacle.actionObjet && !linkEtat.touche.keyA && ( linkEtat.slachSword == 3 || linkEtat.slachSword == 0 ) ){//les touches autre que direction ne sont pas enfoncé et il n'y a pas d'action lié au obstacle en cour ni de coup d'épée
    ...
    if ( (linkEtat.item.sword && linkEtat.touche.keyZ && !linkEtat.touche.keyAPlusObjet && !linkEtat.touche.keyA) || linkEtat.slachSword == 1 || linkEtat.slachSword == 4 || linkEtat.slachSword == 3 ){
      ...
      switch ( linkEtat.touche.directionSword ) {
        case 'S':
          this.testObstacle('top', true,  this.divPersonnage, true );
          break;
        case 'N':
          this.testObstacle('top', false,  this.divPersonnage, true );
          break;
        case 'E':
          this.testObstacle('left', true,  this.divPersonnage, true );
          break;
        case 'W':
          this.testObstacle('left', false,  this.divPersonnage, true );
          break;
      }
      //vérifi si une collision a eu lieu avec l'épée
      if ( linkEtat.touche.keyZPlusObstacle && background.collisionListe[background.stage][linkEtat.collision.position].actionObjet.lift ){
        this.liftObject = this.spriteLink[4][background.collisionListe[background.stage][linkEtat.collision.position].actionObjet.indice];//enregistre l'objet détruit
        background.affiche(this.liftObject, background.item);//objet détruit
        ...
        linkEtat.touche.keyZPlusObstacle = true;//annule la colision
      ...
      if ( linkEtat.slachSword == 0 ) {
        linkEtat.touche.directionSword = linkEtat.touche.direction; //enregistre la direction au début du coup;
      ...
      if ( linkEtat.slachSword == 3 ) {
          this.defaut = 0;
          this.walk = 10;
          if ( !linkEtat.touche.left && !linkEtat.touche.right && !linkEtat.touche.top && !linkEtat.touche.bottom ){//static avec l'épée chargé
      ...
      if ( linkEtat.slachSword == 4 ) { //quand l'épée est chargé l'attaque spéciale est lancé si la touche est laché
        background.item['z-index'] = -1;//cache le scintillement de l'épée
      ...
      if( ( (linkEtat.touche.keyA && !linkEtat.touche.left && !linkEtat.touche.right && !linkEtat.touche.top && !linkEtat.touche.bottom) || linkEtat.touche.keyAPlusObstacle) && !linkEtat.collision.collisionBooleen ){
        ...
        switch(linkEtat.touche.direction){
          ...
          if (background.collisionListe[background.stage][linkEtat.collision.position].actionObjet.chest){//vérifie si on est devant un coffre
            ...
            linkEtat.actionOff.sprite = this.spriteLink[linkEtat.spritePosition.color][0][5][0];//position de link quand il trouve un objet
  ...
  launch : function(timestamp){
    ...
    if ( progress > this.time ){
      if( this.collisionObjet && distanceParcouru < 60 ){
        switch (this.directionObjet) {//distance parcouru par le sprite
          case 'S':
          sens = true;
          axies = 'top';
        ...
        if ( this.spriteLink[this.liftObject.actionObjet.indice][this.objetPosition] ){
          ...
          if (this.objetPosition == 0 && linkAction.directionObjet == 'S'){
            background.item.top = parseFloat(background.item.top) - this.spriteLink[this.liftObject.actionObjet.indice][this.objetPosition].tailleY  + 'px';//modifi la position de la div pour qu'elle ne passe pas le point d'impact
          } else {
            if ( this.objetPosition == 0 && linkAction.directionObjet == 'N' ){background.item.left = (parseFloat(background.item.left) - this.spriteLink[this.liftObject.actionObjet.indice][this.objetPosition].tailleX) + 'px';}//modifi la position de la div pour qu'elle ne passe pas le point d'impact
          }
          background.affiche(this.spriteLink[this.liftObject.actionObjet.indice][this.objetPosition], background.item, true);
          this.objetPosition++;
        }
      }
    }
